...
package com.yy.sdk.installer.loader;
...
import com.yy.sdk.installer.utils.ShareReflectUtil;
...
public class TinkerResourcePatcher {
    ...
    public static void isResourceCanPatch(Context context) throws Throwable {
        ...
        try {
            isUpToDateMethod = ShareReflectUtil.findMethod(assets, "isUpToDate");
        } catch (Throwable ignored) {
            Log.w(TAG, "Fail to find isUpToDate method, insurance logic will be disabled.");
        }
    ...
    public static void monkeyPatchExistingResources(Context context, String externalResourceFile) throws Throwable {
        ...
        if (newAssetManager != null) {
            try {
                ...
                Log.w(TAG, "Patched resources was changed unexpectly, re-inject now.");
            } catch (Throwable thr) {
                Log.w(TAG, "Fail to judge if patched resources is up-to-date, app may crash soon.");
            }
        }
    ...
    private static void installResourceInsuranceHacks(Context context, String patchedResApkPath) {
        ...
        try {
            ...
            if (!(originCallback instanceof ResourceInsuranceHandlerCallback)) {
                ...
                Log.w(TAG, "installResourceInsuranceHacks: already installed, skip rest logic.");
            }
        } catch (Throwable thr) {
        ...
        private boolean hackMessage(Message msg) {
            ...
            if (msg.what == LAUNCH_ACTIVITY || msg.what == RELAUNCH_ACTIVITY) {
                ...
                do {
                    ...
                    if (transaction == null) {
                        Log.w(TAG, "transaction is null, skip rest insurance logic.");
                        break;
                    }
                    ...
                    if (mGetCallbacksMethod == null) {
                        Log.e(TAG, "fail to find getLifecycleStateRequest method, skip rest insurance logic.");
                    ...
                    try {
                        ...
                        Log.e(TAG, "fail to call getLifecycleStateRequest method, skip rest insurance logic.");
                    }
                } while (false);
            }
            if (shouldReInjectPatchedResources) {
                try {
                    ...
                    //Log.printErrStackTrace(TAG, thr, "fail to ensure patched resources available after it's modified.");
                }
            }
            return false;
        }
